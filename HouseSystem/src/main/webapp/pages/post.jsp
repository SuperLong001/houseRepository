...
-->
	...
	<form action="../house/addHouse.action" method="post" name="mf" onsubmit="return validateTitle()">
...
<option value='18'>平谷</option>
			...
			<tr>
			  <td><strong>租金：</strong></td>
				<td><input type="text" name="rental_price"/>元/月</td>
			</tr>
			<tr>
...
<option value='5'>别墅</option>
			...
			<tr>
			  <td><strong>联系电话：</strong></td>
				<td><input type="text" name="contacts_phone"></td>
			</tr>
			<tr>
			  <td><strong>联系人：</strong></td>
				<td><input type="text" name="contacts_name"></td>
			</tr>
			<tr>
			  <td><strong>房屋信息：</strong></td>
				<td><textarea name="house_description" rows="10" cols="40"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
