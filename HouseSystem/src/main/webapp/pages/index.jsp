		...
		$.ajax({
			...
			success:function(data){
				...
				if(data.result==1){
					...
					//成功后页面跳转到登陆成功界面
					window.location.href="../house/pagingQuery.action?currPage=1";
				}else{
					//如果失败就在当前页面显示
					alert("用户名或密码错误");
				}
...
-->
	  ...
	  <table align="center">
		...
		<tr>
		  <td colspan="2"><input type="text" id="userName" size="10" class="editbox"></td>
		</tr>
		<tr>
			<td colspan="2">密&nbsp;&nbsp;码：</td>
			</tr>
		<tr>
		  <td colspan="2"><input type="password" id="userPass" size="10"  class='editbox'></td>
		  </tr>
		<tr>
			<td>
